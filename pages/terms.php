...
<head>
    ...
    <title>Terms &amp; Conditions | The DS</title>
    ...
    <div class="terms-layout">
        <aside class="terms-sidebar" aria-label="Table of contents">
            <nav class="terms-toc">
                ...
                <ul>
                    <?php foreach ($termsSections as $index => $section): ?>
                        <li>
                            <a href="#terms-section-<?= $index + 1; ?>" class="terms-toc-link" data-section="terms-section-<?= $index + 1; ?>">
                                ...
                                <span class="terms-toc-title"><?= htmlspecialchars($section['title']); ?></span>
                            </a>
                        </li>
                    <?php endforeach; ?>
                </ul>
