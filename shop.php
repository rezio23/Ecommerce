    ...
    <footer class="site-footer">
        ...
        <div class="footer-groups">
            ...
            <nav class="footer-group footer-links" aria-label="Footer shop links">
                ...
                <a href="#shop-grid">Accessories</a>
            </nav>
            <nav class="footer-group footer-links footer-links--brands" aria-label="Footer brand links">
                <h2>Brand</h2>
                <div>
                    <a href="#shop-grid">Polo</a>
                    <a href="#shop-grid">Balenciaga</a>
                    <a href="#shop-grid">Prada</a>
                    <a href="#shop-grid">Puma</a>
                    <a href="#shop-grid">Gucci</a>
                    <a href="#shop-grid">Nike</a>
                </div>
            </nav>
        </div>
    </footer>
